		...
		elseif(!isset($_POST['c_terms']) && $_POST['c_terms'] != "on"){
			...
			$contenido = '
				...
				<body>
					...
					<p>Contacta a  ' . $name . ' al correo:  <span style="color:blue;"> ' . $email . '</span> o al teléfono '. $phone .' </p>
					
					<p>Ir a mi sitio web <span style="color:blue">http://www.probus.com/</span></p>
				</body>
				</html>
			';
